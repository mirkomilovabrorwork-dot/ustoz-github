		...
		return (
			<input
				...
				className={classNames(
					...
					"rounded-xl hover:bg-gray-2 autofill:bg-gray-1 hover:border-gray-5 h-[44px] placeholder:text-gray-8 border focus:border-gray-8",
					...
					"ring-0 focus:ring-2 focus:ring-gray-7 ring-offset-0 hover:placeholder:text-gray-12 placeholder:duration-200",
					className,
				)}
				ref={ref}
				{...props}

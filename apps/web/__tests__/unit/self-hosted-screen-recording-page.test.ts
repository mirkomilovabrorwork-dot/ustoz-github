...
const pageSource = tryReadFile(join(process.cwd(), "app/(site)/(seo)/self-hosted-screen-recording/page.tsx"));
...
describe.skipIf(!pageSource)("SelfHostedScreenRecordingPage metadata", () => {

...
const pageSource = tryReadFile(join(process.cwd(), "app/(site)/(seo)/developer-documentation-videos/page.tsx"));
...
describe.skipIf(!pageSource)("DeveloperDocumentationVideosPage metadata", () => {

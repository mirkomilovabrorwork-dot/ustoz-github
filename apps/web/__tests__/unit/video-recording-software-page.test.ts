...
const pageSource = tryReadFile(join(process.cwd(), "app/(site)/(seo)/video-recording-software/page.tsx"));
...
describe.skipIf(!pageSource)("VideoRecordingSoftwarePage metadata", () => {

...
const pageSource = tryReadFile(join(process.cwd(), "app/(site)/(seo)/mac-screen-recording-with-audio/page.tsx"));
...
describe.skipIf(!pageSource)("MacScreenRecordingWithAudioPage metadata", () => {
